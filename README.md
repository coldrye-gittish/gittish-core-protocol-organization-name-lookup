# gittish-core-protocol-organization-name-lookup

This package defines the service interface that is responsible for looking up
organization names in the context of the site.

The service supports the following use cases

* check whether a given organization name was already taken
* look up a list of matching organization names based on user input
...
```
cd <WORKSPACE_ROOT>/gittish-core-protocol-organization-name-lookup
./configure
```
